...
3. **Test the API** by visiting `http://localhost:8321/api/post/all` (after logging in)
...
curl http://localhost:8321/api/post/all -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
